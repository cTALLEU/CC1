...
Le code suivant fonctionne dnas la console mais pas dnas le notebook 
```{r}
library("knitr")
library("BiocStyle")
...
head(out)
```
#Partie II: Infer sequence variants

#première sous partie, on va faire une Dereplication
